...
이전 글인 [**운영 모드와 레지스터**](https://knero.github.io/#/contents?path=/contents/dev/200312/os-study-2.md&date=2020.03.12){:target="_blank"}보다 이번에 다룰 메모리 관리 기법은 내용이 너무 많은 관계로 최대한 축약해서 정리하려고 한다. 
