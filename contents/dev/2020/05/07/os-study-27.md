...
(makefile을 생성해 두었기 때문에 make 를 실행했다. 참고: [커널 빌드 자동화](https://knero.github.io/#/contents?path=/contents/dev/2020/04/14/os-study-15.md&date=2020.04.14&page=2){:target="_blank"})
